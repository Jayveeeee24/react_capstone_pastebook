                    ...
                    <View style={{ flex: 1 }}>
                        <View style={styles.headerContainer}>
                            ...
                            <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                                ...
                                <TouchableOpacity onPress={() => {
                                    onFollow();
                                }} style={{ display: post && post.friend && post.friend.result == "friend_not_found" ? "flex" : "none", backgroundColor: 'lightgray', borderRadius: 5, paddingHorizontal: 14, paddingVertical: 5 }}>
