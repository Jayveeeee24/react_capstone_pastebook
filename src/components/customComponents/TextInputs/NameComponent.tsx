    ...
    return (
        <>
            <View style={[styles.container, { marginBottom: isNameValid ? 10 : 0 }]}>
                ...
                <TextInput placeholder={placeholderText} theme={credentialTextTheme} style={[globalStyles.textDefaults, styles.nameTextInput]} placeholderTextColor={Colors.placeholderTextColor} value={name} onChangeText={setName} />
            </View>
            {!isNameValid && (
